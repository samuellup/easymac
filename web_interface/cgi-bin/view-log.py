...
project = str(arguments['p'].value).strip()


print "Content-type:text/html\r\n\r\n" 
with open('../user_projects/'+project+'/2_logs/log.log') as status_file:
...
<header class="w3-container w3-top w3-hide-large w3-red w3-xlarge w3-padding">
  <a href="javascript:void(0)" class="w3-button w3-red w3-margin-right" onclick="w3_open()"> "here" </a>   # I deleted a non ascii character and replaced it with "here"
  <span>Easymap</span>
</header>
